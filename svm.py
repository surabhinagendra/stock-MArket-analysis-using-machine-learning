...
fout="C:/Users/Surabhi N/Downloads/input data set/finaloutput1.csv"  
filenames="C:/Users/Surabhi N/Downloads/input data set/wipro.csv"    
...
test_X=np.array(data_df[lenght+1:size-1]).values)
...
true_Y=np.array(data_df2['Open'][lenght+2:size])
train_y.append(train_X)

        
data_dict = {train_y:train_X}
             



svm = Support_Vector_Machine()
svm.fit(data=train_X)
